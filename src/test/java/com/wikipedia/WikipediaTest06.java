...
public class WikipediaTest06 {
    ...
    @Test
    public void testHighlightElementsOnLandRoverDefenderPage() {
        ...
        try {
            ...
            assertTrue(title.contains("Land Rover Defender"));
