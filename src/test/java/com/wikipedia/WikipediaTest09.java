...
public class WikipediaTest09 extends BaseTest {
    ...
    public void verifyPageTitle() {
        ...
        assertEquals("Marbella", h1.getText(), "H1 title should match");
    ...
    @Test
    public void verifyCostaDelSolLinkExists() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//a[contains(text(),'Costa del Sol')]")));
        System.out.println("Costa del Sol link verified.");
    }
