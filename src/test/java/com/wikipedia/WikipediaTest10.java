...
public class WikipediaTest10 extends BaseTest {
    ...
    public void verifyPageTitle() {
        ...
        assertEquals("Linux", h1.getText(), "H1 title should match");
    ...
    public void verifyContentSections() {
        List<String> sections = Arrays.asList("History", "Design", "Development");
    ...
    @Test
    public void verifyInfoboxMentionsLinusTorvalds() {
        ...
        assertTrue(infobox.getText().contains("Linus Torvalds"),
                "Infobox should mention Linus Torvalds");
        System.out.println("Linus Torvalds verified in infobox.");
    }
