...
public class WikipediaTest10 {
    ...
    @Test
    public void testHighlightElementsOnLinuxPage() {
        ...
        try {
            ...
            assertTrue(title.contains("Linux"));
