...
public class WikipediaTest07 {
    ...
    @Test
    public void testHighlightElementsOnPeaveyElectronicsPage() {
        ...
        try {
            ...
            assertTrue(title.contains("Peavey Electronics"));
